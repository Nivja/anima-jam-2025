return {
  ...
  dialogue = {
    ...
    "My real passion is building my own design out of the bits and pieces lying around.",
    { "setCharacter", "player" },
    ...
    { "setCharacter", nil },
    "[b][bounce=5]Added Item to Inventory[/bounce][/b][newline][newline]Sami's Pants",
    { "setState", "patch_time" },
    { "unfreeze", "player" },
    { "end" },
    { "tag", "patch_time" },
    ...
    { "setCharacter", "sami" },
    "You know our friend Malika? She started working at the aquaponics labs, anyway I saw she showed me something you'd love!",
    ...
    { "setCharacter", nil },
    "[b][bounce=5]Added Item to Inventory[/bounce][/b][newline][newline]Algae cloth: dyed orange",
    { "unfreeze", "player" },
    { "moveX", "sami", 2 },
